...
## Описание
Трекер-приложение для приобретения новых полезных привычек и искоренения старых плохих привычек.
...
git clone https://github.com/Jylilapa/GoodHabitsApp
...
После запуска push на GitHub запускается проверка flake8 и тесты. После успешного прохождения тестов проект автоматически копируется и развертывается на сервере по публичному IPv4-адресу 158.160.21.51
